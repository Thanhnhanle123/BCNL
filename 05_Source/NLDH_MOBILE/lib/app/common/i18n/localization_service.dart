...
// cái này là Map các language được support đi kèm với mã code của lang đó:
// cái này dùng để đổ data vào Dropdownbutton và set language mà không cần quan tâm tới language của hệ thống
