                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('roleName') is-invalid @enderror"
                                        name="roleName" value="{{ $role->name }}" placeholder="{{ $enterRoleName }}">
                                    @error('roleName')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="roleDisplayName" value="{{ $role->display_name }}" step="any"
                                ...
                                @foreach ($permissionGroups as $permissionGroup)
                                    <div class="col-md-3 m-3"
                                        ...
                                        @foreach ($permissionGroup->permissions as $permission)
                                            <input type="checkbox" value="{{ $permission->id }}" {{$permissionsOfRole->contains("id", $permission->id) ? 'checked' : '' }} name="permission_id[]">
