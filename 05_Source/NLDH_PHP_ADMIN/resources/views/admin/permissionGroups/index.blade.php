                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="float-right btn btn-success"
                                href="{{ route('permissionGroup.create') }}">{{ $add }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($permissionGroups as $permissionGroup)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('permissionGroup.edit', ['id' => $permissionGroup->id]) }}"
                                                    class="btn btn-success">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a class="btn btn-danger action_delete"
                                                    data-url="{{ route('permissionGroup.destroy', ['id' => $permissionGroup->id]) }}">
